...
set output "pdf/muon0.13_R5mTwiss.pdf
 ...
 plot "muon0.13_R5m.twiss" using 3:4 title "muon0.13_R5m.twiss-beta_x",\
      "muon0.13_R5m.twiss" using 3:9 title "muon0.13_R5m.twiss-beta_y",\
      "muon0.13_R5m.twiss" using 3:7 title "muon0.13_R5m.twiss-eta_x"