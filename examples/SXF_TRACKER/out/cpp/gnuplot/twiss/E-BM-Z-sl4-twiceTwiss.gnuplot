...
set output "pdf/E-BM-Z-sl4-twiceTwiss.pdf"
 ...
 plot "E-BM-Z-sl4-twice.twiss" using 3:4 title "E-BM-Z-sl4-twice-beta_x",\
      "E-BM-Z-sl4-twice.twiss" using 3:9 title "E_BM-Z-sl4-twice-beta_y",\
      "E-BM-Z-sl4-twice.twiss" using 3:7 title "E_BM-Z-sl4-twice-eta_x"