...
// Dx_nom =10.40,  Dxp_nom =   0.1; ->  <x> = -1300          -500   < x < -2350 micron
// Dx_nom =13.0,   Dxp_nom =   0.1; ->  <x> =  -1300          -600   < x <  -2100 micron
// Dx_nom =13.0 ,   Dxp_nom =  -0.1 ; ->  <x> = -1300         -400   < x < -2400 micron
// Dx_nom =13.0 ,   Dxp_nom =   0.2 ; ->  <x> = -1300         -800   < x < -2000   micron
